...
class UserTalks extends Component {
  state = {
  ...
  <Animated.View                 // Special animatable View
        style={{
          opacity: fadeAnim,         // Bind opacity to animated value
            ...
            <Text style={stylez.text}>{this.props.talkmyself}</Text>
            </View>
            <View><Text style={{fontFamily: 'Roboto-Regular',
              fontSize: 14,color:'#939393', marginTop: 10, marginRight: 13, alignSelf: 'flex-end'}}>You</Text></View>
