...
import { ImageBackground, Dimensions, Animated, StyleSheet, Text, View, Image, ScrollView, TouchableHighlight } from 'react-native';
          ...
          zindex:1}}>
            ...
            <View style={{width: 250, zindex:-1, marginLeft: 260,}}>
             <Input
                ...
                <View style={stylez.videowrapper}>
                <Video
              source={require('./SoundWaveAlphaMatteVidevo.mp4')}
              rate={1.0}
              volume={1.0}
              muted={false}
              opacity={0}
            ...
            /></View>
            <TouchableHighlight>
            <Animated.View style={this.animateMic()}>
